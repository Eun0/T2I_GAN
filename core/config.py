...
__C.TRAIN.ENCODER_LOSS.DEC = False
__C.TRAIN.ENCODER_LOSS.SENT = ''
__C.TRAIN.ENCODER_LOSS.WORD = False 
__C.TRAIN.ENCODER_LOSS.DISC = '' 
__C.TRAIN.ENCODER_LOSS.VGG = False

__C.TRAIN.SMOOTH = edict()
__C.TRAIN.SMOOTH.MISMATCH = 1.0
__C.TRAIN.SMOOTH.GLOBAL = 0.
__C.TRAIN.SMOOTH.SENT = 1.0
__C.TRAIN.SMOOTH.DISC = 1.0


__C.TRAIN.OPT = edict()
__C.TRAIN.OPT.G_LR = 0.
__C.TRAIN.OPT.G_BETA1 = 0. 
__C.TRAIN.OPT.G_BETA2 = 0.
__C.TRAIN.OPT.D_LR = 0.
__C.TRAIN.OPT.D_BETA1 = 0. 
__C.TRAIN.OPT.D_BETA2 = 0.


__C.GEN = edict()
__C.GEN.ENCODER_NAME = ''
__C.GEN.NORMALIZE = False
__C.GEN.PROJ_TEXT = False

__C.DISC = edict()
__C.DISC.ENCODER_NAME = ''
__C.DISC.ENCODER_DIR = ''
__C.DISC.SPEC_NORM = False
__C.DISC.UNCOND = False
__C.DISC.COND = False
__C.DISC.SENT_MATCH = False
__C.DISC.IMG_MATCH = False
__C.DISC.SEPERATE = False
__C.DISC.NCH = 32
__C.DISC.IS_REC = False
